...
e=0;e<a;e++)if(this._notifications[e].id===b){d=e;break}return d},_findNotificationByMessageAndType:function(b,d){for(var a,e=this._notifications.length,c=0;c<e;c++)if(this._notifications[c].type===d&&this._notifications[c].message===b){a=this._notification[c];break}return a}});
